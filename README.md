...
| `build_item_features.py` | Feature matrix assembly   | Combines all features into single sparse matrix                 |
...
| `RARE_AUTHOR_THRESHOLD`    | 2                        | Authors with fewer items → "**RARE_AUTHOR**"       |
| `RARE_PUBLISHER_THRESHOLD` | 3                        | Publishers with fewer items → "**RARE_PUBLISHER**" |
...
_Report generated from data analysis on uploaded datasets._
